...
INSERT INTO `tbadmin` (`idadmin`, `username`, `pwadmin`, `hashadmin`)
VALUES (1, 'admin', 'admin123', '$2y$10$BFCwg6zCyQYpUuRu01r9mOrotaTjIMe779VjMTBBNIJdAIvtsD9Ta');
...
INSERT INTO `tbsewa` (`idsewa`, `idadat`, `nama_cust`, `email`, `notelp`, `kota`, `tgl_sewa`, `jenisbayar`,
                      `harga_total`, `statusbayar`)
VALUES (1, 4, 'Fikri', 'hamatrol9@gmail.com', 2147483647, 'Depok', '2025-10-31', 'Full', 6000000, 'Dibatalkan'),
